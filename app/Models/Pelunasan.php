...
class Pelunasan extends Model
{
    ...
    protected $fillable = [
        'gadai_id', 'nasabah_id', 'officer_id', 'no_sbg', 'order_id', 'transaction_id',
        'nilai_pinjaman', 'jasa_persen', 'jasa_nominal', 'denda_persen',
        'denda_nominal', 'hari_terlambat', 'total_tebus', 'tgl_pelunasan',
        'tgl_jt', 'status_bayar', 'metode_bayar', 'midtrans_order_id',
        'midtrans_token', 'midtrans_url', 'midtrans_response',
    ];
