<section id="cabang" class="relative bg-[#1F5C3A] grid-pattern-light py-24 overflow-hidden">
    <div class="max-w-screen-xl mx-auto px-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl mx-auto">
            @foreach([
                ['nama'=>'BATIM GADAI Mangli','jam'=>'Senin - Sabtu, 07.00 - 17.00 WIB','telp'=>'0812-3456-7001','alamat'=>'Jl. Kauman No. 92, Karang Miuwo, Kaliwates, Jember, Jawa Timur','maps'=>'https://maps.app.goo.gl/TwAdJLpp4Y4ta8FJ7','delay'=>''],
                ['nama'=>'BATIM GADAI Semanggi','jam'=>'Senin - Sabtu, 07.00 - 17.00 WIB','telp'=>'0812-3456-7002','alamat'=>'Jl. Brantas 2 No. 30, Tegal Boto Lor, Sumbersari, Jember, Jawa Timur','maps'=>'https://maps.app.goo.gl/xPX6pWxzvCdxDXxo8','delay'=>'fade-up-delay-1'],
                ['nama'=>'BATIM GADAI Karimata','jam'=>'Senin - Sabtu, 07.00 - 17.00 WIB','telp'=>'0812-3456-7003','alamat'=>'Jl. Karimata No. 15, Jember, Jawa Timur','maps'=>'https://maps.google.com/?q=Jl.+Karimata+No.+15+Jember','delay'=>'fade-up-delay-2'],
            ] as $cabang)
            <div class="fade-up {{ $cabang['delay'] }} bg-white/5 border border-white/10 rounded-2xl p-6 hover:bg-white/10 hover:-translate-y-1.5 transition-all duration-300">
                ...
                <div class="space-y-3 text-sm text-white/60 mb-5">
                    <div class="flex items-center gap-3">
                        ...
                        <span>{{ $cabang['jam'] }}</span>
                    </div>
                    <div class="flex items-center gap-3">
                        <svg class="w-4 h-4 text-[#B6D96C] flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M2.25 6.75c0 8.284 6.716 15 15 15h2.25a2.25 2.25 0 002.25-2.25v-1.372c0-.516-.351-.966-.852-1.091l-4.423-1.106c-.44-.11-.902.055-1.173.417l-.97 1.293c-.282.376-.769.542-1.21.38a12.035 12.035 0 01-7.143-7.143c-.162-.441.004-.928.38-1.21l1.293-.97c.363-.271.527-.734.417-1.173L6.963 3.102a1.125 1.125 0 00-1.091-.852H4.5A2.25 2.25 0 002.25 4.5v2.25z"/>
                        </svg>
                        <span>{{ $cabang['telp'] }}</span>
                    </div>
                    <div class="flex items-start gap-3">
                        <svg class="w-4 h-4 text-[#B6D96C] mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M15 10.5a3 3 0 11-6 0 3 3 0 016 0z"/><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M19.5 10.5c0 7.142-7.5 11.25-7.5 11.25S4.5 17.642 4.5 10.5a7.5 7.5 0 1115 0z"/>
                        </svg>
                ...
                <div class="flex gap-2">
                    ...
                    <a href="{{ $cabang['maps'] }}" target="_blank"
