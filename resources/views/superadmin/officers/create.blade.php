...
<div class="rounded-2xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03]">
    <div class="px-6 py-5 border-b border-gray-200 dark:border-gray-800">
        <h3 class="text-base font-semibold text-gray-800 dark:text-white">Form Tambah Petugas</h3>
        <p class="text-sm text-gray-500 dark:text-gray-400 mt-0.5">Isi data petugas dengan lengkap dan benar.</p>
    </div>

    <form method="POST" action="{{ route(auth()->user()->role . '.petugas.store') }}" enctype="multipart/form-data" class="p-6">
        @csrf
