...
@php
$pengajuan = [
    ['no_sbg' => '2506SMG000001', 'nasabah' => 'Budi Santoso', 'barang' => 'iPhone 13 Pro', 'cabang' => 'Semanggi', 'taksiran' => 'Rp 3.500.000', 'status' => 'Menunggu'],
    ['no_sbg' => '2506MGL000001', 'nasabah' => 'Dewi Rahayu', 'barang' => 'Laptop Asus', 'cabang' => 'Mangli', 'taksiran' => 'Rp 2.800.000', 'status' => 'Menunggu'],
    ['no_sbg' => '2506KRM000001', 'nasabah' => 'Eko Prasetyo', 'barang' => 'Samsung A54', 'cabang' => 'Karimata', 'taksiran' => 'Rp 1.200.000', 'status' => 'Menunggu'],
    ['no_sbg' => '2506SMG000002', 'nasabah' => 'Siti Aminah', 'barang' => 'Motor Yamaha NMAX', 'cabang' => 'Semanggi', 'taksiran' => 'Rp 8.000.000', 'status' => 'Menunggu'],
    ['no_sbg' => '2506MGL000002', 'nasabah' => 'Rudi Hartono', 'barang' => 'iPad Pro', 'cabang' => 'Mangli', 'taksiran' => 'Rp 4.500.000', 'status' => 'Menunggu'],
];
@endphp
    ...
    <div class="rounded-2xl border border-gray-200 bg-white p-5 dark:border-gray-800 dark:bg-white/[0.03] md:p-6">
        ...
        <div class="flex items-end justify-between mt-5">
            <div>
                ...
                <h4 class="mt-2 font-bold text-gray-800 text-title-sm dark:text-white/90">18.500</h4>
            </div>
    ...
    <div class="rounded-2xl border border-gray-200 bg-white p-5 dark:border-gray-800 dark:bg-white/[0.03] md:p-6">
        ...
        <div class="flex items-end justify-between mt-5">
            <div>
                ...
                <h4 class="mt-2 font-bold text-gray-800 text-title-sm dark:text-white/90">342</h4>
            </div>
            <span class="flex items-center gap-1 rounded-full bg-success-50 py-0.5 pl-2 pr-2.5 text-sm font-medium text-success-600 dark:bg-success-500/15 dark:text-success-500">
                <svg class="fill-current" width="12" height="12" viewBox="0 0 12 12"><path fill-rule="evenodd" clip-rule="evenodd" d="M5.56462 1.62393C5.70193 1.47072 5.90135 1.37432 6.12329 1.37432C6.31631 1.37415 6.50845 1.44731 6.65505 1.59381L9.65514 4.5918C9.94814 4.88459 9.94831 5.35947 9.65552 5.65246C9.36273 5.94546 8.88785 5.94562 8.59486 5.65283L6.87329 3.93247L6.87329 10.125C6.87329 10.5392 6.53751 10.875 6.12329 10.875C5.70908 10.875 5.37329 10.5392 5.37329 10.125L5.37329 3.93578L3.65516 5.65282C3.36218 5.94562 2.8873 5.94547 2.5945 5.65248C2.3017 5.35949 2.30185 4.88462 2.59484 4.59182L5.56462 1.62393Z" fill=""/></svg>
                12.5%
    ...
    <div class="col-span-12 xl:col-span-4 overflow-hidden rounded-2xl border border-gray-200 bg-white px-5 pt-5 sm:px-6 sm:pt-6 dark:border-gray-800 dark:bg-white/[0.03]">
        ...
        <div class="flex justify-center gap-6 pb-4">
            <div class="flex items-center gap-2">
                <span class="w-2.5 h-2.5 rounded-full bg-[#1F5C3A]"></span>
                <span class="text-xs text-gray-500 dark:text-gray-400">Semanggi</span>
            </div>
            <div class="flex items-center gap-2">
                <span class="w-2.5 h-2.5 rounded-full bg-[#B6D96C]"></span>
                <span class="text-xs text-gray-500 dark:text-gray-400">Mangli</span>
            </div>
            <div class="flex items-center gap-2">
                <span class="w-2.5 h-2.5 rounded-full bg-[#174a2e]"></span>
                <span class="text-xs text-gray-500 dark:text-gray-400">Karimata</span>
            </div>
        </div>
    </div>
</div>
            ...
            <tbody>
                ...
                <tr class="border-t border-gray-100 dark:border-gray-800">
                    <td class="py-3 pr-4 whitespace-nowrap">
                        <p class="font-medium text-gray-800 text-theme-sm dark:text-white/90">{{ $item['no_sbg'] }}</p>
                    </td>
                    <td class="py-3 pr-4 whitespace-nowrap">
...
<script type="module">
    ...
    if (chartSixEl) {
        const options = {
            series: [
                { name: 'Gadai', data: [12, 18, 15, 22, 19, 25, 30, 28, 35, 20, 18, 24] },
                { name: 'Perpanjangan', data: [8, 12, 10, 15, 13, 18, 22, 20, 25, 14, 12, 16] },
                { name: 'Pelunasan', data: [5, 8, 7, 10, 9, 12, 15, 14, 18, 10, 8, 11] },
            ],
...
setTimeout(function() {
    ...
    if (pieEl && typeof ApexCharts !== 'undefined') {
        new ApexCharts(pieEl, {
            ...
            labels: ['Semanggi', 'Mangli', 'Karimata'],
            colors: ['#1F5C3A', '#B6D96C', '#174a2e'],
            legend: { show: false },
            dataLabels: { enabled: false },
            plotOptions: {
