...
@section('content')
    ...
    @php
        $pengajuan = [
            [
                'no_sbg' => '2506SMG000001',
                'nasabah' => 'Budi Santoso',
                'barang' => 'iPhone 13 Pro',
                'cabang' => 'Semanggi',
                'taksiran' => 'Rp 3.500.000',
                'status' => 'Menunggu',
            ],
            [
                'no_sbg' => '2506MGL000001',
                'nasabah' => 'Dewi Rahayu',
                'barang' => 'Laptop Asus',
                'cabang' => 'Mangli',
                'taksiran' => 'Rp 2.800.000',
                'status' => 'Menunggu',
            ],
            [
                'no_sbg' => '2506KRM000001',
                'nasabah' => 'Eko Prasetyo',
                'barang' => 'Samsung A54',
                'cabang' => 'Karimata',
                'taksiran' => 'Rp 1.200.000',
                'status' => 'Menunggu',
            ],
            [
                'no_sbg' => '2506SMG000002',
                'nasabah' => 'Siti Aminah',
                'barang' => 'Motor Yamaha NMAX',
                'cabang' => 'Semanggi',
                'taksiran' => 'Rp 8.000.000',
                'status' => 'Menunggu',
            ],
            [
                'no_sbg' => '2506MGL000002',
                'nasabah' => 'Rudi Hartono',
                'barang' => 'iPad Pro',
                'cabang' => 'Mangli',
                'taksiran' => 'Rp 4.500.000',
                'status' => 'Menunggu',
            ],
        ];
    @endphp
    ...
    <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 xl:grid-cols-4 md:gap-6 mb-6">
        ...
        <div class="rounded-2xl border border-gray-200 bg-white p-5 dark:border-gray-800 dark:bg-white/[0.03] md:p-6">
            ...
            <div class="flex items-end justify-between mt-5">
                <div>
                    <span class="text-sm text-gray-500 dark:text-gray-400">Total Nasab ah</span>
                    ...
                    @foreach ($pengajuan as $item)
                        <tr class="border-t border-gray-100 dark:border-gray-800">
                            <td class="py-3 pr-4 whitespace-nowrap">
                                <p class="font-medium text-gray-800 text-theme-sm dark:text-white/90">{{ $item['no_sbg'] }}
                                </p>
                            </td>
                            <td class="py-3 pr-4 whitespace-nowrap">
        ...
        <script type="module">
            ...
            if (chartSixEl) {
                const options = {
                    series: [{
                            name: 'Gadai',
                            data: [12, 18, 15, 22, 19, 25, 30, 28, 35, 20, 18, 24]
                        },
                        {
                            name: 'Perpanjangan',
                            data: [8, 12, 10, 15, 13, 18, 22, 20, 25, 14, 12, 16]
                        },
                        {
                            name: 'Pelunasan',
                            data: [5, 8, 7, 10, 9, 12, 15, 14, 18, 10, 8, 11]
                        },
                    ],
