...
@section('content')
    ...
    <div class="rounded-2xl border border-gray-200 bg-white pt-4 dark:border-gray-800 dark:bg-white/[0.03]">
        ...
        <div class="flex flex-col gap-4 px-6 mb-4 sm:flex-row sm:items-center sm:justify-between">
            <div>
                <h3 class="text-lg font-semibold text-gray-800 dark:text-white/90">Data Cabang</h3>
            ...
            <div class="flex items-center gap-3">
                ...
                <a href="{{ route('superadmin.pimpinan') }}?export=1&search={{ request('search') }}"
                    ...
                    <svg class="stroke-current" width="20" height="20" viewBox="0 0 20 20" fill="none">
                        <path d="M10 2.5V13.5M10 13.5L6 9.5M10 13.5L14 9.5M3 15.5H17" stroke="" stroke-width="1.5"
            ...
            <table class="w-full">
                <thead class="border-t border-y border-gray-100 bg-gray-50 dark:border-gray-800 dark:bg-gray-900">
                    <tr>
                        ...
                        <th class="px-6 py-3 text-left text-theme-xs font-medium text-gray-500 dark:text-gray-400">Alamat
                        </th>
                        <th class="px-6 py-3 text-left text-theme-xs font-medium text-gray-500 dark:text-gray-400">No. Telp
                        </th>
                        <th class="px-6 py-3 text-left text-theme-xs font-medium text-gray-500 dark:text-gray-400">Status
                        </th>
        ...
        <div
            ...
            <p class="text-sm text-gray-500 dark:text-gray-400">
                Menampilkan {{ $branches->firstItem() ?? 0 }}–{{ $branches->lastItem() ?? 0 }} dari
                {{ $branches->total() }}
                data
            </p>
            <div class="flex items-center gap-2">
                <a href="{{ $branches->previousPageUrl() }}"
                    ...
                    <svg width="16" height="16" viewBox="0 0 20 20" fill="none">
                        <path fill-rule="evenodd" clip-rule="evenodd"
                            d="M2.58301 9.99868C2.58272 10.1909 2.65588 10.3833 2.80249 10.53L7.79915 15.5301C8.09194 15.8231 8.56682 15.8233 8.85981 15.5305C9.15281 15.2377 9.15297 14.7629 8.86018 14.4699L5.14009 10.7472L16.6675 10.7472C17.0817 10.7472 17.4175 10.4114 17.4175 9.99715C17.4175 9.58294 17.0817 9.24715 16.6675 9.24715L5.14554 9.247１５L8.860１７ ５．５３０１６C９．１５２９７ ５．２３７１７ ９．１５２８２ ４．７６２３ ８．８５９８３ ４．４６９５C８．５６６８４ ４．１７６７ ８．０９１９７ ４．１７６８５ ７．７９９１７ ４．４６９８４L２．８４１６７ ９．４３０４９C２．６８３２１ ９．５６８ ２．５８３０１ ９．７７０８７ ２．５８３０１ ９．９９７１５C２．５８３０１ ９．９９７６６ ２．５８３０１ ９．９９８１７ ２．５８３０１ ９．９９８６８Z"
                            fill="currentColor" />
                    </svg>
    ...
    <div id="modalHapus" class="hidden fixed inset-0 z-99999 flex items-center justify-center bg-black/50">
        <div class="bg-white dark:bg-gray-900 rounded-2xl shadow-xl w-full max-w-md mx-4">
            <div class="p-6 text-center">
                <div
                    class="flex items-center justify-center w-14 h-14 rounded-full bg-red-50 dark:bg-red-500/10 mx-auto mb-4">
                    <svg class="text-red-500" width="28" height="28" viewBox="0 0 24 24" fill="none"
                        stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"
                            d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16" />
                    </svg>
                ...
                <p class="text-sm text-gray-500 dark:text-gray-400 mb-6">
                    Apakah Anda yakin ingin menghapus data pimpinan <span id="deleteNama"
                        class="font-semibold text-gray-800 dark:text-white"></span>? Tindakan ini tidak dapat dibatalkan.
                </p>
