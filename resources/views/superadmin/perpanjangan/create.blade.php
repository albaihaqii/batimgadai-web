...
<x-common.page-breadcrumb pageTitle="Perpanjangan Gadai" />
...
<div class="grid grid-cols-1 gap-6 lg:grid-cols-3">
    ...
    <div class="lg:col-span-2 space-y-6">
        ...
        <div class="rounded-2xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03]">
            <div class="px-6 py-5 border-b border-gray-200 dark:border-gray-800">
                ...
                <p class="text-sm text-gray-500 dark:text-gray-400 mt-0.5">Detail gadai yang akan diperpanjang.</p>
            </div>
            <div class="p-6">
                <div class="grid grid-cols-2 gap-5">
                    ...
                    <div>
                        <p class="text-xs text-gray-500 dark:text-gray-400">Jatuh Tempo Saat Ini</p>
                    ...
                    <div>
                        ...
                        @php
                            $statusConfig = [
                                ...
                                'jatuh_tempo'  => 'bg-error-50 text-error-600',
                                'perpanjangan' => 'bg-blue-50 text-blue-600',
                            ];
                        @endphp
                        <span class="inline-block mt-1 rounded-full px-2 py-0.5 text-theme-xs font-medium {{ $statusConfig[$gadai->status] ?? 'bg-gray-100 text-gray-600' }}">
        ...
        <div class="rounded-2xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03]">
            <div class="px-6 py-5 border-b border-gray-200 dark:border-gray-800">
                <h3 class="text-base font-semibold text-gray-800 dark:text-white">Rincian Biaya Perpanjangan</h3>
                <p class="text-sm text-gray-500 dark:text-gray-400 mt-0.5">Perhitungan biaya otomatis berdasarkan ketentuan.</p>
            </div>
            <div class="p-6">
                <div class="space-y-3">
                    ...
                    @endif
                    <div class="flex justify-between items-center py-2.5 border-b border-gray-100 dark:border-gray-800">
                        <span class="text-sm text-gray-500 dark:text-gray-400">Jatuh Tempo Baru</span>
                        <span class="text-sm font-semibold text-brand-500">{{ $hitungan['tgl_jt_baru'] }}</span>
                    </div>
                    <div class="flex justify-between items-center py-2.5">
                        <span class="text-base font-bold text-gray-800 dark:text-white">Total Bayar</span>
                        <span class="text-base font-bold text-brand-500">
                            Rp {{ number_format($hitungan['total_bayar'], 0, ',', '.') }}
                        </span>
                    </div>
                </div>
            </div>
        ...
        {{-- Form Pilih Metode --}}
        <form method="POST" action="{{ route(auth()->user()->role . '.transaksi.perpanjangan.store') }}" id="formPerpanjangan">
        @csrf
        ...
        <div class="rounded-2xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03]">
            <div class="px-6 py-5 border-b border-gray-200 dark:border-gray-800">
                ...
                <p class="text-sm text-gray-500 dark:text-gray-400 mt-0.5">Pilih metode pembayaran biaya perpanjangan.</p>
            </div>
            <div class="p-6">
    ...
    <div class="space-y-6">
        <div class="rounded-2xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-white/[0.03]">
            <h4 class="text-sm font-semibold text-gray-800 dark:text-white mb-4">Ketentuan Perpanjangan</h4>
            <div class="space-y-4">
                @foreach([
                    ['num' => '1', 'text' => 'Perpanjangan memperpanjang masa gadai 30 hari dari hari ini'],
                    ['num' => '2', 'text' => 'Biaya jasa 5% dari nilai pinjaman'],
                    ['num' => '3', 'text' => 'Denda ≤15 hari terlambat: 2.5% dari nilai pinjaman'],
                    ['num' => '4', 'text' => 'Denda >15 hari terlambat: 5% dari nilai pinjaman'],
                    ['num' => '5', 'text' => 'SBG perpanjangan baru akan diterbitkan otomatis'],
                ] as $step)
        ...
        <div class="rounded-2xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-white/[0.03]">
            ...
            <div class="space-y-3">
                ...
                <div class="flex justify-between items-center py-2">
                    ...
                    <span class="text-sm font-bold text-brand-500">Rp {{ number_format($hitungan['total_bayar'], 0, ',', '.') }}</span>
                </div>
            </div>
        </div>
    </div>
